...
class Order04Screen extends StatelessWidget {
  const Order04Screen({super.key});
  ...
  static const _order = _OrderCardData(
    image: '🥤',
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              const Icon(Icons.search_rounded, color: Color(0xFFBBBBBB), size: 24),
              const SizedBox(width: 10),
              Expanded(
                child: Text(
                  text,
                  style: TextStyle(
                    color: isPlaceholder ? const Color(0xFFBBBBBB) : const Color(0xFF272727),
                    fontSize: 16,
                    fontWeight: FontWeight.w500,
                  ),
                ),
              ),
              const Icon(Icons.tune_rounded, color: Color(0xFF1F1F1F), size: 22),
            ],
          ),
        ),
      ),
