...
import 'burger08.dart';
import 'burger09.dart';
import 'burger_detail_widgets.dart';

class Burger07Screen extends StatelessWidget {
  const Burger07Screen({super.key});

  static const routeName = '/burger07';
  ...
  Widget build(BuildContext context) {
    return BurgerDetailFrame(
      bottomBar: BurgerBottomActionBar(
        onPressed: () =>
            Navigator.pushNamed(context, Burger08Screen.routeName),
      ),
